...
public class EntryPointer {
    ...
    public static void main(String[] args) {
        try {
            ...
            mod.init(new net.minecraftforge.fml.common.event.FMLInitializationEvent(null, null, null, null));
            mod.postInit(new net.minecraftforge.fml.common.event.FMLPostInitializationEvent(null, null, null, null));
