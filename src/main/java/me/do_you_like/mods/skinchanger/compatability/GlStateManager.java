...
/**
 * Stolen from newer versions of minecraft.
 */
public class GlStateManager {
    ...
    static class AlphaState {
        GlStateManager.BooleanState alphaTest;
        int func;
        float ref;
    ...
    static class BlendState {
        GlStateManager.BooleanState blend;
        int srcFactor;
        int dstFactor;
        int srcFactorAlpha;
        int dstFactorAlpha;
    ...
    static class ColorLogicState {
        GlStateManager.BooleanState colorLogicOp;
        int opcode;
    ...
    static class ColorMaterialState {
        GlStateManager.BooleanState colorMaterial;
        int face;
        int mode;
    ...
    static class CullState {
        GlStateManager.BooleanState cullFace;
        int mode;
    ...
    static class FogState {
        GlStateManager.BooleanState fog;
        int mode;
        float density;
        float start;
        float end;
    ...
    static class PolygonOffsetState {
        GlStateManager.BooleanState polygonOffsetFill;
        GlStateManager.BooleanState polygonOffsetLine;
        float factor;
        float units;
    ...
    static class StencilState {
        GlStateManager.StencilFunc field_179078_a;
        int field_179076_b;
        int field_179077_c;
        int field_179074_d;
        int field_179075_e;
    ...
    static class TexGenCoord {
        GlStateManager.BooleanState textureGen;
        int coord;
        public int param = -1;

        TexGenCoord(int p_i46254_1_, int p_i46254_2_) {
    ...
    static class TexGenState {
        ...
        GlStateManager.TexGenCoord r;
        GlStateManager.TexGenCoord q;
    ...
    static class TextureState {
        GlStateManager.BooleanState texture2DState;
        int textureName;
