...
public class DefaultPlayerSkin {
    ...
    /**
     * Retrieves the default skin for this player. Depending on the model used this will be Alex or
     * Steve.
     */
    ...
    /**
     * Retrieves the type of skin that a player is using. The Alex model is slim while the Steve model
     * is default.
     */
    ...
    /**
     * Checks if a players skin model is slim or the default. The Alex model is slime while the Steve
     * model is default.
     */
